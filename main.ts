...
import { Data, Edge, FlowNode, MessageData, Queues } from "./types";
import * as TreeModel from "tree-model";
// import * as dotenv from "dotenv";
import { data as exampleData } from "./example";
import {
  addToSegment,
  sendEmail,
...
const startJourney = (id: number, data: Data) => {
  api
    .get(`journey/${id}`)
    .then(async (res) => {
...
startJourney(2, exampleData);
// console.log(AllQueues);

/**
 * TODO:
 * logic for conditional nodes
 * 5 mins scheduling
 */
